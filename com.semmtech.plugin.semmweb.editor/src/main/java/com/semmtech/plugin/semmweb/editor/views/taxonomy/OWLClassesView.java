 ...
 * @author Sander Stolk
 */
public class OWLClassesView extends AbstractTaxonomyView {

    public static final String ID = "com.semmtech.plugin.semmweb.editor.views.taxonomy.owlclasses";
    private static OWLClassesView singleton;

    public OWLClassesView() {
        super("Classes of Individuals");
        singleton = this;
    }
    ...
    public boolean isTaxonomyDefaultRootSelectable() {
        return getVisibleModelURIs().contains(OWL.getURI());
    }
    ...
    public static class ToggleInstanceCountHandler extends AbstractHandler implements
            IElementUpdater {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.toggleInstanceCount";
    ...
    public static class ChangeTaxonomyRootHandler extends SelectedResourceHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.changeTaxonomyRoot";

        public static final String PARAMETER_ROOT_RESOURCE_URI = "owlclasses.changeTaxonomyRoot.rootResourceURI";
        public static final String PARAMETER_USE_SELECTED = "owlclasses.changeTaxonomyRoot.useSelected";
    ...
    public static class ChangeTaxonomyRootToTopClassesHandler extends AbstractHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.setTaxonomyRootToTopClasses";
    ...
    public static class RefreshViewHandler extends AbstractHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.refreshView";
    ...
    public static class CreateSubClassHandler extends SelectedResourceHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.createSubClass";
    ...
    public static class CreateComplementOfClassHandler extends SelectedResourceHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.createComplementOfClass";
    ...
    public static class CreateIntersectionClassHandler extends SelectedResourceHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.createIntersectionClass";
    ...
    public static class CreateUnionClassHandler extends SelectedResourceHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.createUnionClass";
    ...
    public static class CreateEquivalentClassHandler extends SelectedResourceHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.createEquivalentClass";
    ...
    public static class CreateSiblingHandler extends SelectedResourceHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.createSiblingClass";
    ...
    public static class CreateInstanceHandler extends SelectedResourceHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.createInstance";
    ...
    public static class RemoveSubClassHandler extends SelectedResourceHandler {
        public static final String ID = "com.semmtech.plugin.semmweb.editor.commands.owlclasses.removeSubClass";
