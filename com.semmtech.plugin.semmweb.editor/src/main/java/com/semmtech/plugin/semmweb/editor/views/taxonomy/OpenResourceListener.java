...
public class OpenResourceListener implements OpenResourceEventListener {

    private AbstractTaxonomyView taxonomyView;

    public OpenResourceListener(AbstractTaxonomyView taxonomyView) {
    ...
    public void resourceActivated(OntResource resource) {
        taxonomyView.updateViewerWithActiveResource();
    }
