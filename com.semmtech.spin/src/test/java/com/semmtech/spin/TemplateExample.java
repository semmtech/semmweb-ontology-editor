...
public class TemplateExample {
    ...
    public static void main(String[] args) {
        ...
        model.add(SystemTriples.getVocabularyModel()); // Add some queryable
                                                       // triples
    ...
    private static Template createTemplate(Model model) {
        ...
        Template template = model.createResource(NS + "MyTemplate", SPIN.Template).as(
                Template.class);
        ...
        // argument.addProperty(SPL.predicate, model.getProperty(ARG.NS +
        // "predicate"));
        // argument.addProperty(SPL.valueType, RDF.Property);
        // argument.addProperty(RDFS.comment,
        // "The predicate to get the value of.");
