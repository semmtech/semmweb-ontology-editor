...
import com.semmtech.semantics.skos.OrderedCollection;
import com.semmtech.semantics.vocabulary.SKOS;


public class OrderedCollectionImpl extends SKOSIndividualImpl implements OrderedCollection {

    public OrderedCollectionImpl(Node node, EnhGraph graph) {
        super(node, graph);
    }
