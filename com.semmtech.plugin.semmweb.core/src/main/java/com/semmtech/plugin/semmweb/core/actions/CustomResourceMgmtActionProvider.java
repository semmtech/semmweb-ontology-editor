...
/**
 * Copy of the class ResourceMgmtActionProvider without the
 * "Close Unrelated Projects" command
 */
public class CustomResourceMgmtActionProvider extends CommonActionProvider {
    ...
    protected void makeActions() {
                    ...
                    public IStatus runInWorkspace(IProgressMonitor monitor) throws CoreException {
                        try {
                            ...
                            throw new CoreException(new Status(IStatus.ERROR, CorePlugin.PLUGIN_ID,
                                    IStatus.ERROR, "Exception in {0}. run: {1}",
        ...
        refreshAction.setDisabledImageDescriptor(CorePlugin.getDefault().getImageDescriptor(
                CorePluginImages.IMG_REFRESH_NAV_DIS));
        refreshAction.setImageDescriptor(CorePlugin.getDefault().getImageDescriptor(
                CorePluginImages.IMG_REFRESH_NAV_EN));
