 ...
 */
public class ResourceEditorPropertyPage extends AbstractProjectPropertyPage {

    private static final Logger logger = Logger.getLogger(ResourceEditorPropertyPage.class);

    public static final String ID = "com.semmtech.plugin.semmweb.publication.pages.resourceEditor";
    ...
    public ResourceEditorPropertyPage() {
        super();
    ...
    public void setElement(IAdaptable element) {
        ...
        if (project == null) {
            throw new IllegalStateException("The project must not be null");
        }

        editorPreference = ResourceEditorPreference.fromProject(project);
        preferences = editorPreference.getResourceEditorPreferences();
    ...
    public void createTaxonomyModel() {
        ...
        for (String uri : Arrays.asList(new String[] { RDF.getURI(),
            ...
            try {
                LoadModelJob.loadSubModel(uri, manager.doAltURLMapping(uri), taxonomyModel);
            }
            catch (Throwable t) {
            }
    ...
    protected Control createContents(Composite parent) {
        ...
        checkDomainRestrictionsCheckbox.setSelection(editorPreference.checkDomainRestrictions());
        ...
        hideRestrictionCheckbox
                .setText("Hide subclass statements containing restrictions in 'All Properties' section");
        hideRestrictionCheckbox.setSelection(editorPreference.hideRestrictionStatements());
            ...
            private String getColumnText(Object element, int columnIndex) {
                if (columnIndex == 0) {
                    if (element instanceof AllPropertiesSettingItem) {
                        ...
                        Resource property = taxonomyModel.getResource(item.getPropertyUri());
    ...
    public boolean performOk() {
        editorPreference.setResourceEditorPreferences(preferences);
        editorPreference.setCheckDomainRestrictions(checkDomainRestrictionsCheckbox.getSelection());
        editorPreference.setHideRestrictionStatements(hideRestrictionCheckbox.getSelection());

        try {
            editorPreference.save();
        }
        catch (IOException e) {
            String message = String.format("An error occurred while saving Editor Preference:",
                    e.getMessage());
    ...
    protected void performDefaults() {
        ...
        editorPreference.setCheckDomainRestrictions(true);
        editorPreference.setHideRestrictionStatements(true);
        editorPreference.setResourceEditorPreferences(preferences);
