...
/**
 * Workbench-level composite for choosing a container. Copy of Eclipse's
 * internal class org.eclipse.ui.internal.ide.misc.ContainerSelectionGroup
 * 
 */
public class ContainerSelectionGroup extends Composite {
    ...
    private static final String DEFAULT_MSG_SELECT_ONLY = "Message select only";
    ...
    public void containerSelectionChanged(IContainer container) {
        ...
        if (allowNewContainerName) {
            if (container == null) {
                ...
                String text = TextProcessor.process(container.getFullPath().makeRelative()
                        .toString());
    ...
    public void setSelectedContainer(IContainer container) {
        ...
        List<Object> itemsToExpand = Lists.newArrayList();
