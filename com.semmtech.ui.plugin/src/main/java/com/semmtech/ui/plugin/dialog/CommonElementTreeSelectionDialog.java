 ...
 * @author Sander Stolk
 */
public class CommonElementTreeSelectionDialog extends SelectionStatusDialog {
    ...
    private String fEmptyListMessage = "No entries available."; //$NON-NLS-1$
     ...
     */
    public CommonElementTreeSelectionDialog(Shell parent) {
        super(parent);
    ...
    protected TreeViewer doCreateTreeViewer(Composite parent, int style) {
        CommonFilterViewer viewer = new CommonFilterViewer(parent, style);
        fContentProvider = (ITreeContentProvider) viewer.getContentProvider();
        fLabelProvider = (ILabelProvider) viewer.getLabelProvider();
        return viewer;
    }
