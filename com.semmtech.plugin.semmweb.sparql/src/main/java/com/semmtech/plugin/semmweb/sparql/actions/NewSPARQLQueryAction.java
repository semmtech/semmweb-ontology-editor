...
import com.semmtech.plugin.semmweb.sparql.wizards.NewSparqlQueryFileWizard;


public class NewSPARQLQueryAction extends Action {
     ...
     */
    public NewSPARQLQueryAction(IWorkbenchWindow window) {
        super("SPARQL Query");
        if (window == null) {
            throw new IllegalArgumentException();
        }
        this.window = window;
        setDescription("Open a wizard to create a new SPARQL query.");
        setImageDescriptor(SparqlPlugin.getDefault().getImageDescriptor(
                SparqlPluginImages.IMG_SPARQL_FILE_ADD));
    }
